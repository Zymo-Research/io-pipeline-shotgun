process SOURMASH_GATHER {
    ...
    sourmash gather $sketch \$DB --dna --ksize ${params.sourmash_kmersize} --threshold-bp ${params.sourmash_threshold_bp} -o ${prefix}_sourmashgather.csv --picklist $picklist:match_name:ident 2> ${prefix}_sourmashgather.log
