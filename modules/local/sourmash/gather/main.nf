process SOURMASH_GATHER {
    ...
    """
    LIST=`find -L "sourmash_database" -name "*${params.sourmash_kmersize}.txt"`
    DB=`find -L "sourmash_database" -name "*${params.sourmash_kmersize}.zip"`
    LINEAGE=`find -L "sourmash_database" -name "*.csv"`

    sourmash scripts fastgather $sketch \$LIST -k ${params.sourmash_kmersize} -o ${prefix}_fastgather.csv 2> ${prefix}_fastgather.log
